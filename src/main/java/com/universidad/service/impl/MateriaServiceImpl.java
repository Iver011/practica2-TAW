...
private DocenteRepository docenteRepository;
  ...
  private MateriaDTO mapToDTO(Materia materia) {
    ...
    return MateriaDTO.builder()
            ...
            .docentes(materia.getDocentes() != null ?
                materia.getDocentes().stream().map(docente -> docente.getId()).collect(Collectors.toList()) : null)
            .build();
}
    ...
    if (materiaDTO.getDocentes() != null && !materiaDTO.getDocentes().isEmpty()) {
    materia.setDocentes(docenteRepository.findAllById(materiaDTO.getDocentes()));
}
    ...
    public MateriaDTO actualizarMateria(Long id, MateriaDTO materiaDTO) {
        ...
        materia.setPrerequisitos(null); // o lista vacía si prefieres
    }
        // Map other fields as necessary
